---
title: "Database Setup: SQLite and SQL Server Connections"
...
<Note>
  `mssql-django` 1.6 — the version pinned in `requirements.txt` — is the first release with official Django 5 support. Earlier versions of `mssql-django` are not compatible with Django 5.x.
</Note>
