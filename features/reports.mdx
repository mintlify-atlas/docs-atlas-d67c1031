---
title: "Operational Reports: Raw Material and Personnel Exports"
...
<Tabs>
  ...
  <Tab title="Personal">
    **URL parameter:** `?tipo=personal`
    ...
    GET /reportes/?tipo=personal&page=2
    GET /reportes/?tipo=personal&fecha_inicio=2025-01-01&fecha_fin=2025-01-31&page=3
    ```

    The personal report is paginated at 10 records per page. Use `?page=N` to navigate between pages.
  </Tab>
</Tabs>
