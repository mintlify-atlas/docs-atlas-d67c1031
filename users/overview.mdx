---
title: "User Management in Planta Milenio"
sidebarTitle: "Overview"
description: "Understand how Planta Milenio manages admin users with per-module boolean permissions, read-only mode, and account locking."
---
